...
import { advancedMotion, AdvancedStagger, EASING } from '@/lib/animation-system';
import { useOptimizedAnimation } from '@/lib/animation-performance';
