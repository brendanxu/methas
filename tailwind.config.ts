...
import { southPoleColorSystem } from './src/lib/colors';
...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // South Pole Brand Colors - 科学生成的色彩系统
        primary: southPoleColorSystem.primary,
        secondary: southPoleColorSystem.secondary,
        success: southPoleColorSystem.success,
        warning: southPoleColorSystem.warning,
      ...
      keyframes: {
        ...
        glow: {
          '0%': { boxShadow: '0 0 5px rgba(0, 33, 69, 0.5)' },
          '100%': { boxShadow: '0 0 20px rgba(0, 33, 69, 0.8)' },
        },
        shimmer: {
